...
exports.build = gulp.series(cleanAssets, publishHtmlProduction, publishFonts, publishImages, publishJs, compileScssProduction);
exports.build_dev = gulp.series(cleanAssets, publishHtmlDevelopment, publishFonts, publishImages, publishJs, compileScssDevelopment);
exports.watch = gulp.series(cleanAssets, publishHtmlDevelopment, publishFonts, publishJs, publishImages, compileScssDevelopment, serve, watchFiles);